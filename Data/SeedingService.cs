...
using SiteTeste.Models.Enums;

namespace SiteTeste.Data
{
    public class SeedingService
    {
        private SiteTesteContext _context;

        public SeedingService(SiteTesteContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            SalesRecord r1 = new SalesRecord(1, new DateTime(2018, 09, 25), 11000.0, SaleStatus.Canceled, s1);
